...
*game*    |[roguelike.h](https://github.com/MichaelMackus/libroguelike)                                                        **(1   C, MIT)**         |**Simple single-header game library for roguelike games in C99. Includes pathfinding, Dijkstra graphs, dungeon generation, and more.**
